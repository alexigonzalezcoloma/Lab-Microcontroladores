...
while True:
    #get= Panta.mouse.getclick()  ;   print get.pos
    rate(10);

    
    parte1.rotate(angle = math.radians(2), axis=(0,1,0), origin = parte1.pos)
    parte2.rotate(angle = math.radians(2), axis=(1,0,0), origin = (39,118,-25))
    parte3.rotate(angle = math.radians(2), axis=(1,0,0), origin = (0 ,140,-10))
    parte4.rotate(angle = math.radians(2), axis=(0,0,1), origin = parte4.pos  )
